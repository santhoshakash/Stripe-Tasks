...
//     );
//     const { uid, email } = credential.user;
//     db.collection("users").do(uid).set({ email }, { merge: true });
//   };
// }

// return(
//   <button onCick = {() => signIn}
//   signin with google>NO TRY</button>
// );

// export function signOut(props)
// return props.user  && (
//  <button onCick = {() =>auth.siut()}
//   sign with google>NO TRY</button>
// )
